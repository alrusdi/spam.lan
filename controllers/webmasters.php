...
class webmasters_controller extends base_controller {
	private $pway=Array(
						Array('name'=>'home', 'path'=>''),
						Array('name'=>'webmasters', 'path'=>'webmasters/')
					);
